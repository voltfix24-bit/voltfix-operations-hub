...
- [ ] 2. Pricing: shared formatter, service-specific base, planned discount, remove "30 minuten"
- [ ] 3. Planned flow fetches availability -> TimeSlotCalendar; time window stored
...
- [ ] 8. Tests: pricing tests, remove example test, test+build green
